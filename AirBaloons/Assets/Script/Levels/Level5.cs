...
namespace Assets.Script.Levels
{
    public class Level5 : ILevel
    {
        ...
        public Level5()
        {
            ...
            {
                { LevelSettings.LevelTimer / 2f, new FloatItem("Prefabs/Actors/Blimp1", GameSettings.BornPoints[BornPoint.Clock_6]) },          // after 1/3 level time
                { LevelSettings.LevelTimer / 2f + 10, new FloatItem("Prefabs/Actors/Blimp1", GameSettings.BornPoints[BornPoint.Clock_3]) }
            };
        }
    }
}
