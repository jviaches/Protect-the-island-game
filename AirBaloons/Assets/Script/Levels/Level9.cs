...
{
    public class Level9 : ILevel
    {
        public int LevelIndex { get { return 9; } }
        ...
        public Level9()
        {
            timeActivationDic = new Dictionary<float, FloatItem>
            {
                ...
                { LevelSettings.LevelTimer / 6.66f, new FloatItem("Prefabs/Actors/Blimp1", GameSettings.BornPoints[BornPoint.Clock_7]) },      // after 2/3 level time
                { LevelSettings.LevelTimer / 6.67f, new FloatItem("Prefabs/Actors/Blimp1", GameSettings.BornPoints[BornPoint.Clock_9]) }      // after 2/3 level time
            };
        }
    }
}
