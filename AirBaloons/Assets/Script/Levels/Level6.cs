    ...
    public class Level6 : ILevel
    {
        ...
        public Level6()
        {
            timeActivationDic = new Dictionary<float, FloatItem>
            {
                ...
                { LevelSettings.LevelTimer / 2f, new FloatItem("Prefabs/Actors/Blimp1", GameSettings.BornPoints[BornPoint.Clock_6]) },      // after 1/2 level time
                { LevelSettings.LevelTimer / 6.66f, new FloatItem("Prefabs/Actors/Blimp1", GameSettings.BornPoints[BornPoint.Clock_9]) }      // after 1/2 level time
            };
        }
    }
}
