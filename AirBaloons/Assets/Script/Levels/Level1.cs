    ...
    public class Level1 : ILevel
    {
        ...
        public Level1(GameSettings gameSettings)
        {
            TimeActivationDic = new List<KeyValuePair<float, FloatItem>>()
            {
                ...
                { new KeyValuePair<float, FloatItem>( 31f, new FloatItem("Prefabs/Actors/Balloon" + UnityEngine.Random.Range(1, 3), gameSettings.BornPoints[BornPoint.Clock_5])) },
                { new KeyValuePair<float, FloatItem>( 35f, new FloatItem("Prefabs/Actors/Balloon" + UnityEngine.Random.Range(1, 3), gameSettings.BornPoints[BornPoint.Clock_3])) },
                ...
                { new KeyValuePair<float, FloatItem>( 51f, new FloatItem("Prefabs/Actors/Balloon" + UnityEngine.Random.Range(1, 3), gameSettings.BornPoints[BornPoint.Clock_5])) },
